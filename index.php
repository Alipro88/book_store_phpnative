...
<form action="" method="post" class="add-product-form " enctype="multipart/form-data">
   ...
   <input type="text" maxlength="50" name="p_description" placeholder="enter the product description" class="box" required>
   <input type="file" name="p_image" accept="image/png, image/jpg, image/jpeg" class="box" required>
   <input type="submit" value="add the product" name="add_product" class="delete-btn">
</form>
...
<section class="edit-form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" class="box" placeholder="enter the name ..." required name="update_p_name" value="<?php echo $fetch_edit['name']; ?>">
      <input type="number" min="0" class="box" placeholder="enter the price ..." required name="update_p_price" value="<?php echo $fetch_edit['price']; ?>">
      <input type="text"  min="0" class="box"  placeholder="enter the description ..."  required name="update_p_description" value="<?php echo $fetch_edit['description']; ?>">
      ...
      <a  type="reset"  href="index.php" id="close-edit" class="option-btn" >   cancel        </a>
   </form>
